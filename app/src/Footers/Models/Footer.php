...
use Maverick\Footers\Models\FooterMainLinks;
 ...
 * @since    30 June 2022
 */
class Footer extends DataObject implements CMSPreviewable
{

    private static $singular_name = 'Footer';
     ...
     * @return string
     */
    private static $table_name = 'Footers';
    ...
    private static $many_many = [
      "MainLinks" => FooterMainLinks::class,
    ];
